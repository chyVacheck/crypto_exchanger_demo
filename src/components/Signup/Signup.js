  ...
  return (
    <>
      {props.infoPopupState.isError && (
        <InfoPopup message={alertText.serverError} imgType={false} onClose={props.onInfoPopupClose} />
      )}
      <div className="signup">
        <p className="signup__title">Register and trade!</p>
        <Form buttonText="Sign up" onSubmit={handleSubmit} isFormValid={isFormValid}>
          <label className="form__inputs-box">
            ...
            />
            <span
              className={`form__input-alert ${validatedFields.name ? '' : 'form__input-alert_pink'}`}
              id="name-alert"
            >
              {alertText.name}
            </span>
          ...
          <label className="form__inputs-box">
            ...
            />
            <span
              className={`form__input-alert ${validatedFields.password ? '' : 'form__input-alert_pink'}`}
              id="password-alert"
            >
              {alertText.password}
            </span>
