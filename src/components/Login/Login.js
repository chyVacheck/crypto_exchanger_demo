  ...
  return (
    <>
      {props.infoPopupState.isError && (
        <InfoPopup message={alertText.userNotFound} imgType={false} onClose={props.onInfoPopupClose} />
      )}
      <div className="login">
        <p className="login__title">Welcome!</p>
        <Form buttonText="Login" onSubmit={handleSubmit} isFormValid={isFormValid}>
