  ...
  return (
    <div className="infoPopup" onClick={onClose}>
      <div className="infoPopup__container">
        <img className="infoPopup__close-button link-effect" src={closeIcon} alt="Close" onClick={onClose} />
        <img className="infoPopup__icon" src={imgType ? yesIcon : noIcon} alt={`${imgType}`} />
