...
function PopupMenu({ isOpen, onClose, loggedIn, onLogout }) {
  ...
  return (
    <section className={`popupMenu ${isOpen ? 'popupMenu_opened' : ''}`} onClick={handleOverlay}>
      <dir className="popupMenu__container">
        <img className="popupMenu__close-button link-effect" src={closeIcon} alt="Close" onClick={onClose} />
        ...
        {loggedIn ? (
          <div className="popupMenu__account">
            ...
            <Navigation mode="vertical" content={accountNavBar} onClick={onClose}></Navigation>
