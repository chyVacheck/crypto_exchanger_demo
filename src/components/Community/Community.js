  ...
  return (
    <section className="community">
      ...
      <h2 className="community__subtitle">
        ...
        <span className="community__subtitle community__subtitle_bold">social media</span>
        &ensp;and&ensp;
        <span className="community__subtitle community__subtitle_bold">news channels</span>
      </h2>
      <p className="community__text">... and you could join the conversation.</p>
      <p className="community__text community__text_small">
        This is a text about how big is the project's community and how you could benefit of becoming it's member. Don't
        trust such texts.
      </p>
            ...
            <div className="community__content">
              <div className="community__item-line">
                <p className="community__item-title">
                  <img className="community__img" src={item.logosrc} alt={item.name} />
                  {item.name}
                </p>
