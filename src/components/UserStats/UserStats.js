    ...
    <div className="stats">
      <div className="stats__data">
        <p className="stats__text">
          <span className="stats__text stats__text_grey">Registration date:&nbsp;</span>
          {userStats.accountDate}
        </p>
        <p className="stats__text">
          <span className="stats__text stats__text_grey">Invested amount:&nbsp;</span>
          {userStats.investedAmount}
        </p>
        <p className="stats__text">
          <span className="stats__text stats__text_grey">Total transactions:&nbsp;</span>
          {userStats.transactions}
        </p>
        <p className="stats__text">
          <span className="stats__text stats__text_grey">Current funds:&nbsp;</span>
          {userStats.totalFunds}
        </p>
      </div>
      <div className="stats__profit">
        <p className="stats__text stats__text_grey">Your profit</p>
        <p className={`stats__text stats__text_large ${props.totalFunds < 10000 && 'stats__text_pink'}`}>
          {userStats.profit}
        </p>
      </div>
    </div>
